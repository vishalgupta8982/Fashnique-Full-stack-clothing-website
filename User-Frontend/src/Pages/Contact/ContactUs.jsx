            ...
            <div className="ContactContainer md:flex-row flex-col-reverse md:w-[90vw]">
                ...
                <div className="md:w-1/2 contactInputsContainer">
                     ...
                     <p className="feelFree">Feel free to contact us and we will get back to you as soon as it possible</p>
                        <input value={enqDetail.name} className="contactInput" type="text" readOnly={true} placeholder="Name" />

                     <input className="contactInput" value={enqDetail.email} readOnly={true} type="text" placeholder="Email" />
                     <input className="contactInput" value={enqDetail.mobile} readOnly={true} type="text" placeholder="Mobile" />
                        <textarea className="contactInput" onChange={(e) => setEnqDetail({ ...enqDetail, comment: e.target.value })} value={enqDetail.comment} name="message" rows="4" placeholder="message" />
                        <div onClick={submit}> 
                            <Button title={"Submit"} widthButton={"98%"} /></div>
                </div>
