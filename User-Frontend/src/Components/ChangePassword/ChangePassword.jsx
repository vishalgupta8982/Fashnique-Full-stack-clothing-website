            ...
            <div className="changePassword w-[screen]   min-h-[73vh]   ">
                <div className="chngPswwrdCard ">
                    ...
                    <div className='inputContainer'>
                        ...
                        <input onChange={(e)=>handleChange(e,'currentPassword')} value={passwords.currentPassword}  className='outline-none'  type={showCurrPswrd ? 'password' : 'text'} placeholder='Current Password' id="" />
                    ...
                    <div className='inputContainer'>
                        ...
                        <div className='inputCp'>
                            <input onChange={(e) => handleChange(e, 'newPassword')} value={passwords.newPassword} className='outline-none' type={showNewPswrd ? 'password' : 'text'} placeholder='Current Password' id="" />
                    ...
                    <div className='mb-3 inputContainer'>
                        ...
                        <div className='inputCp'>
                            <input onChange={(e)=>setConfirmPassword(e.target.value)} value={confirmPassword} className='outline-none' type={showCnfNewPswrd ? 'password' : 'text'} placeholder='Current Password' id="" />
                            <span onClick={() => setShowCnfNewPNew(!showCnfNewPswrd)} className='eye'>
                                {showCnfNewPswrd ? (<FaEyeSlash />) : (<FaEye />)}
                            </span></div>
                    </div>
                    <div onClick={update}> 
                        <Button title={"Update Password"} /></div>
                </div>
            </div>
        </>
    )
