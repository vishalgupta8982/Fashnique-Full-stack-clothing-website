    ...
    <>
      <div className='personalInfoCont px-5 w-[100%] md:w-[90%]'>
        <div className='flex flex-row items-center'>
          ...
          <p className='piHead'>Personal Information</p>
        </div>
        <div className='flex flex-col piInfo'>
          ...
          <div className='flex flex-col md:flex-row'>
            <div className='piInputCont'>
              ...
              <input
                className={`piInput w-[90%]    ${editPi ? `text-[#000]` : `text-[Grey]`} `}
                readOnly={!editPi}
                type='text'
          ...
          <div className='piInputCont'>
            ...
            <input
              className={`piInput w-[90%] md:w-[45%] ${editPi ? `text-[#000]` : `text-[Grey]`} `}
              readOnly={!editPi}
              type='text'
          ...
          <div className='piInputCont'>
            ...
            />
            <div className={`checkbox-container w-[90%] md:w-[45%]  `}>
