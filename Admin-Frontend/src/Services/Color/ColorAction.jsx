...
export const addColor = (token, title) => async (dispatch) => {
...
export const deleteColor = (id, token) => async (dispatch) => {
...
export const getaColor = (id, token) => async (dispatch) => {
...
export const updateColor = (id, token, title) => async (dispatch) => {

    dispatch(updateColorRqst());
    try {
        const response = await axios.put(`${baseUrl}/color/${id}`, { title }, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        })
